...
export default function AttractionsSection() {
  ...
  return (
    <section id="okolica" className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-2 text-muted">Pomysły na spacer, widoki i szybki plan dnia.</p>

      {items.length === 0 ? (
        <div className="mt-6 card-soft p-5">
          <p className="text-sm text-neutral-800/75">
            Brak atrakcji — uzupełnij <code>site.attractions</code> w <code>src/data/site.ts</code>.
          </p>
        </div>
      ) : (
